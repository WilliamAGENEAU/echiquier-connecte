...
import 'package:app_echiquier/ui/figure_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Stack(
        children: [
          Container(
            color: cell.isBlack ? Colors.black : Colors.white,
          ),
          AnimatedContainer(
            duration: const Duration(milliseconds: 300),
            color: isSelected ? const Color(0xFFC9EEA7) : Colors.transparent,
          ),
          AnimatedContainer(
            duration: const Duration(milliseconds: 300),
